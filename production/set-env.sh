...
export DEVICE_LIFECYCLE_SERVICE=http://v1.apps.citus.io/apisrv/device-management-service
export AUTH0_CLIENT_SECRET=
export OPENFPT_API_KEY=

export CITUS_CASSANDRA_REST=http://localhost:8020/api/v1/proxy/namespaces/default/services/citus-cassandra-rest:80
export CITUS_APPLICATION_GATEWAY=http://localhost:8020/api/v1/proxy/namespaces/default/services/citus-application-gateway:8001
